...
6.  单击**分享链接**右侧的**复制**图标。
    ...
    **说明：** 移动端可视化应用项目发布后，如果您想更换分享链接，可单击**分享链接**右侧的![重新生成链接](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/5992634951/p93475.png)（**重新生成链接**）图标，重新生成一个**分享链接**。重新生成后，旧的分享链接将不可用，请使用新的分享链接访问目标移动端可视化应用。
    ...
    在手机浏览器中粘贴复制的链接，在线访问您的移动端可视化应用。 打开浏览器，将复制的链接粘贴到地址栏中，即可在线访问您的移动端可视化应用。

    移动端可视化应用分享成功后，您可以配置[分享信息](#section_m86_op7_msz)的参数内容，还可以进行[访问限制](#section_fwz_b1m_zfa)和[发布快照](#section_86l_dhv_as7)的配置。
...
![分享链接样例展示](../images/p164697.png "分享链接样例展示（钉钉产品内）")
...
4.  单击下发**管理快照**，可在管理快照界面管理多个历史快照，详情请参见[快照管理](#section_l49_o0e_ogh)。
